...
// we change the 3d column values order as they are negative
const INTUITIONISTIC_FUZZY_DM_FINAL = [
  ...
  [[0.2, 0.4], [0.4, 0.1], [0.9, 0.0], [0.8, 0.1], [0.2, 0.5], [0.7, 0.1]],
  [[0.5, 0.2], [0.3, 0.6], [0.6, 0.3], [0.7, 0.1], [0.6, 0.2], [0.5, 0.3]],
]

const W_IFNS = [0.15, 0.25, 0.14, 0.16, 0.20, 0.10]

const W_IFHA_OPERATOR = [0.0865, 0.1716, 0.2419, 0.2419, 0.1716, 0.0865]
